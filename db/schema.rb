...
ActiveRecord::Schema[7.1].define(version: 2025_10_23_025019) do
  ...
  create_table "horario_atencions", force: :cascade do |t|
    ...
    t.index ["doctor_id", "fecha", "hora_inicio"], name: "index_horario_atencions_on_doctor_id_and_fecha_and_hora_inicio", unique: true
