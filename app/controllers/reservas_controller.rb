class ReservasController < ApplicationController
  ...
  unless Rails.env.development?
    redirect_to reservas_path, alert: 'Esta función solo está disponible en modo desarrollo'
    return
  end
  ...
  unless paciente && doctor
    redirect_to reservas_path, alert: 'Necesitas crear al menos un paciente y un doctor primero'
    return
  end

  # Crear reservas de prueba para todos los estados
  reservas_creadas = []

  # Reserva pendiente (mañana)
  ...
  redirect_to reservas_path, notice: "✅ Se crearon #{reservas_creadas.size} reservas de prueba exitosamente"
  end
