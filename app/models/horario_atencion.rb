...
class HorarioAtencion < ApplicationRecord
  ...
  scope :futuros, -> { where(fecha: Time.zone.today..) }
  ...
  def fecha_no_pasada
    ...
    return unless fecha < Time.zone.today
  ...
  def hora_fin_mayor_a_inicio
    ...
    return unless hora_fin <= hora_inicio
  ...
  def no_solapamiento_horarios
    ...
    return unless horarios_solapados.exists?
